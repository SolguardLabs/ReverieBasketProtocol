...
export interface ReverieBasketTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DOMAIN_SEPARATOR"
      | "PERMIT_TYPEHASH"
...
export interface ReverieBasketToken extends BaseContract {
  connect(runner?: ContractRunner | null): ReverieBasketToken;
  waitForDeployment(): Promise<this>;

  interface: ReverieBasketTokenInterface;
